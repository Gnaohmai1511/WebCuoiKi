...
<body>
    ...
    <form action="EditMatch" method="post">
        ...
        <input type="datetime-local" id="match_date" name="match_date" value="<%= request.getAttribute("matchDate") %>" required><br><br>

        <label for="stadium">Sân Vận Động:</label>
        <input type="text" id="stadium" name="stadium" value="<%= request.getAttribute("stadium") %>" required><br><br>

        <label for="home_score">Tỷ Số Đội Chủ Nhà:</label>
        <input type="number" id="home_score" name="home_score" value="<%= request.getAttribute("homeScore") %>" min="0"><br><br>

        <label for="away_score">Tỷ Số Đội Khách:</label>
        <input type="number" id="away_score" name="away_score" value="<%= request.getAttribute("awayScore") %>" min="0"><br><br>
